...
void test11(Buddy::Allocator& raw_alloc)
{
    ...
    SafeRef one = list(OP_ADD, list(OP_ALL, q(1), q(2), q(3), 0, q(4)), list(OP_ANY), list(OP_NOTALL), list(OP_NOTALL, q(1), q(2), list(OP_STRLEN, q("hello"), 0, q(1), q("foo"))), list(OP_ANY, 0, 0, 0, list(OP_RC, q(1), q(2),q(3))));
